...
<body>
    ...
    <nav id="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="/health">Adoption Form</a></li>
            @auth
                <li><a href="/adoptions/my">My Applications</a></li>
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        @auth
            <a href="/adoptions/my">My Applications</a>
    ...
    <div class="search-overlay" id="searchOverlay">
        ...
        <div class="search-inner">
            ...
            <div class="search-suggestions">
                ...
                <div class="search-tag">Adoption Form</div>
